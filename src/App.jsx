  ...
  try {
    if (window.microsoftTeams) {
      return new Promise(resolve => {
        ...
        // Hard timeout: if Teams doesn't respond in 5s, fall back to "default"
        // so the app doesn't hang forever (Supabase fetch never starts otherwise).
        setTimeout(() => safeResolve("default"), 5000);
        try {
