            ...
            <div style={{display:"flex",flexDirection:"column",gap:13}}>
              ...
              {form.type!=="sector"&&(<>
                <div style={{display:"grid",gridTemplateColumns:form.type==="milestone"?"1fr":"1fr 1fr",gap:10}}>
                  <F label={form.type==="milestone"?"날짜 (연-월-일)":"시작일 (연-월-일)"}>
                    ...
                    {form.start && <div style={{fontSize:10,color:T.textFaint,marginTop:3,fontFamily:"ui-monospace, monospace"}}>{form.start}</div>}
                  </F>
                  {form.type!=="milestone"&&
                    <F label="종료일 (연-월-일)">
                      <input type="date" value={form.end} onChange={e=>setForm({...form,end:e.target.value})} style={SB.inp}/>
                      {form.end && <div style={{fontSize:10,color:T.textFaint,marginTop:3,fontFamily:"ui-monospace, monospace"}}>{form.end}</div>}
                    </F>
                  }
                </div>
                <F label="섹터">
